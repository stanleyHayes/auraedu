...
export const tokens = {
  ...
  ink: { 950: "#16241D", 900: "#1D2F27", 800: "#24382F", 600: "#48594F", 400: "#7C8B82", 200: "#A6B2AA" },
...
export const theme = {
  light: {
    background: "#F4F5F1", surface: "#FBFCF9", foreground: "#16241D",
    muted: "#EFF1EB", mutedForeground: "#7C8B82", border: "#DCE0D8",
    primary: "#C6402F", primaryForeground: "#FFFFFF", ring: "#C6402F",
  },
  dark: {
    background: "#16241D", surface: "#1D2F27", foreground: "#EAEDE6",
    muted: "#132019", mutedForeground: "#A6B2AA", border: "#2B3D34",
    primary: "#E36A54", primaryForeground: "#16241D", ring: "#E36A54",
  },
} as const;
