...
import (
	...
	servercmd "github.com/auraedu/content-service/cmd/server"
	workercmd "github.com/auraedu/content-service/cmd/worker"
...
func main() {
	root := &cobra.Command{Use: "content-service", Version: version}
