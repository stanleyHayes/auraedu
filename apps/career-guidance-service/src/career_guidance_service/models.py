...
class Guidance(Base):
    ...
    tenant_id: Mapped[str] = mapped_column(String(64))
    student_id: Mapped[str] = mapped_column(String(36))
    guidance_type: Mapped[str] = mapped_column(String(50))
    ...
    __table_args__ = (Index("idx_guidance_student", "tenant_id", "student_id"),)


class GuidanceOutbox(Base):
    __tablename__ = "guidance_outbox"
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
