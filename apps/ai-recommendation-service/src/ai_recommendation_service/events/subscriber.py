"""Event subscriber that feeds the AI feature store."""
...
from ai_recommendation_service.events.envelope import MAX_EVENT_BYTES
from ai_recommendation_service.models import FeatureStoreMetric

__all__ = ["MAX_EVENT_BYTES", "FeatureStoreSubscriber", "nats", "settings"]
