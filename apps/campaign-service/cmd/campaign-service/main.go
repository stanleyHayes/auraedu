...
import (
	...
	servercmd "github.com/auraedu/campaign-service/cmd/server"
	workercmd "github.com/auraedu/campaign-service/cmd/worker"
...
func main() {
	root := &cobra.Command{Use: "campaign-service", Version: version}
