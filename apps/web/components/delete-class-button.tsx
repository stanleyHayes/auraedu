...
import { deleteClassAction, type AcademicActionResult } from "@/lib/academic-actions";
...
export function DeleteClassButton({ id, name }: DeleteClassButtonProps) {
  const [state, formAction, pending] = React.useActionState<AcademicActionResult, FormData>(
    deleteClassAction.bind(null, id),
    {},
  );
