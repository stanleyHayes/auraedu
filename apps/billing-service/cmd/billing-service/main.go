// Command billing-service is the billing-service service CLI.
package main
...
import (
	...
	servercmd "github.com/auraedu/billing-service/cmd/server"
	workercmd "github.com/auraedu/billing-service/cmd/worker"
