...
const features = [
  {
    ...
    desc: "Profiles, guardians, enrolments and documents in one record.",
  },
  {
    key: "academics",
    name: "Academics",
    desc: "Classes, subjects, timetables and grading schemes per school.",
  },
  {
    key: "attendance",
    name: "Attendance",
    desc: "Daily and per-subject registers with instant presence counts.",
  },
  {
    key: "assessments",
    name: "Assessments",
    desc: "Tests, exams, scores and report cards, term after term.",
  },
  {
    key: "fees",
    name: "Fees & communication",
    desc: "Invoices, receipts, announcements and parent messaging.",
  },
  {
    key: "analytics",
    name: "Analytics",
    desc: "Attendance, academic and financial dashboards by role.",
  },
];
...
const steps = [
  {
    ...
    desc: "Enter the school name and admin details; we generate your tenant code.",
  },
  {
    n: "02",
    title: "Pick a plan",
    desc: "Start with a free trial, then choose the plan that matches your modules.",
  },
  {
    n: "03",
    title: "Switch on features",
    desc: "Enable attendance, assessments, fees and more — only what you need.",
  },
  {
    n: "04",
    title: "Go live",
    desc: "Import students and staff, set your brand, and start the term.",
  },
];
...
const testimonials = [
  {
    quote:
      "AuraEDU replaced three separate tools. Our register, results and fees now live in one place.",
    school: "University Practice SHS",
    role: "Administrator",
  },
  {
    quote: "Parents finally see report cards and invoices on the same day they are published.",
    school: "Aboom AME Zion C Basic",
    role: "Head Teacher",
  },
  {
    quote: "Setting up a new term took hours, not weeks.",
    school: "Cape Coast Prep",
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-14 px-6 py-16 lg:grid-cols-[1.04fr_0.96fr] lg:py-20">
        <div>
          ...
          <p className="mt-6 max-w-[36ch] text-lg leading-relaxed text-muted-foreground">
            AuraEDU runs the whole school — admissions, registers, results, report cards and fees —
            for many schools at once. Each keeps its own brand, data, and features.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="flex flex-col gap-3.5">
            ...
            <p className="max-w-[58ch] text-muted-foreground">
              Start with the essentials and switch on advanced features when you need them. Each
              module keeps its own data and permissions.
            </p>
          </div>
          <div className="mt-9 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div
                key={f.key}
                className="rounded-lg border border-border bg-surface p-5 transition-colors hover:border-[var(--color-brand)]/40"
              >
      ...
      <section id="join" className="px-6 pb-4 pt-16">
        <div className="mx-auto max-w-6xl rounded-xl bg-ink-950 p-10 text-paper-50 sm:p-14">
          ...
          <p className="mt-4 max-w-[46ch] text-ink-200">
            Create the school, choose a plan, switch on the features you need, upload your logo and
            colours, import students and staff — then go live.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Button
              variant="secondary"
              asChild
              className="h-11 border-ink-800 bg-transparent px-5 text-paper-50 hover:bg-ink-900"
            >
