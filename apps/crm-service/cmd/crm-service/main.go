...
import (
	...
	servercmd "github.com/auraedu/crm-service/cmd/server"
	workercmd "github.com/auraedu/crm-service/cmd/worker"
...
func main() {
	root := &cobra.Command{Use: "crm-service", Version: version}
