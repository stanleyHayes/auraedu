// Command staff-service is the staff-service service CLI.
package main
...
import (
	...
	servercmd "github.com/auraedu/staff-service/cmd/server"
	workercmd "github.com/auraedu/staff-service/cmd/worker"
	"github.com/spf13/cobra"
)

const serviceName = "staff-service"
...
func main() {
	...
	root.AddCommand(&cobra.Command{
		Use:   "worker",
		Short: "Run the " + serviceName + " outbox worker",
