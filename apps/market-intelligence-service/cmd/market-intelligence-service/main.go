...
import (
	...
	servercmd "github.com/auraedu/market-intelligence-service/cmd/server"
	workercmd "github.com/auraedu/market-intelligence-service/cmd/worker"
...
func main() {
	root := &cobra.Command{Use: "market-intelligence-service", Version: version}
