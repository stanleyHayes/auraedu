// Package student resolves parent and learner scope from student-service.
package student
...
func (c *Client) Resolve(ctx context.Context, tenantID, userID, role string) (_ []string, returnErr error) {
	...
	defer func() { returnErr = errors.Join(returnErr, res.Body.Close()) }()
