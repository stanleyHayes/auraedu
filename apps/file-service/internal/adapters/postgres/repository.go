...
func (r *Repository) Create(ctx context.Context, tenantID string, e *domain.File) error {
	_ = ctx
	_ = tenantID
	_ = e
...
func (r *Repository) GetByID(ctx context.Context, tenantID, id string) (*domain.File, error) {
	_ = ctx
	_ = tenantID
	_ = id
...
func (r *Repository) List(ctx context.Context, tenantID string, limit int, cursor string) ([]*domain.File, string, error) {
	_ = ctx
	_ = tenantID
	_ = limit
	_ = cursor
