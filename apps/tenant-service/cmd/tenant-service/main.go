// Command tenant-service is the tenant-service service CLI.
package main
...
import (
	...
	servercmd "github.com/auraedu/tenant-service/cmd/server"
	workercmd "github.com/auraedu/tenant-service/cmd/worker"
