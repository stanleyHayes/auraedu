// Command audit-service is the audit-service service CLI.
package main
...
import (
	...
	servercmd "github.com/auraedu/audit-service/cmd/server"
	workercmd "github.com/auraedu/audit-service/cmd/worker"
