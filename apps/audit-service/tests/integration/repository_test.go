...
func mustInsert(t *testing.T, ctx context.Context, repo ports.Repository, tenantID, eventType, subject string) *domain.AuditLog {
	t.Helper()
...
func TestRepository_InsertAndList(t *testing.T) {
	...
	log := mustInsert(t, ctx, repo, tenantA, "student.created.v1", "stu-1")
...
func TestRepository_TenantIsolation(t *testing.T) {
	...
	mustInsert(t, aCtx, repo, tenantA, "student.created.v1", "stu-a")
...
func TestRepository_ListPagination(t *testing.T) {
	...
	log1 := mustInsert(t, ctx, repo, tenantA, "student.created.v1", "stu-1")
	time.Sleep(10 * time.Millisecond)
	mustInsert(t, ctx, repo, tenantA, "student.updated.v1", "stu-2")
