# Chapter 20: Frontend Engineering

## Purpose

Web and mobile consume shared contracts and tokens while presenting role-specific, accessible and feature-aware experiences.

---

## Scope

Product, engineering, operational and governance decisions directly related to frontend engineering.
...
- Changes to frontend engineering must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for frontend engineering.
...
- A story affecting frontend engineering updates this chapter and its executable evidence in the same review.
