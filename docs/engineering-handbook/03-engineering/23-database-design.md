# Chapter 23: Database Design

## Purpose

Database Design defines the shared rules, boundaries and evidence for this part of the AuraEDU education operating system.

---

## Scope

Product, engineering, operational and governance decisions directly related to database design.
...
- Changes to database design must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for database design.
...
- A story affecting database design updates this chapter and its executable evidence in the same review.
