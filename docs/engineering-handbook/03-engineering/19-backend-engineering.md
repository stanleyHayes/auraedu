# Chapter 19: Backend Engineering

## Purpose

Go services use hexagonal boundaries; Python AI services use equivalent port-and-adapter separation; business logic stays out of transport handlers.

---

## Scope

Product, engineering, operational and governance decisions directly related to backend engineering.
...
- Changes to backend engineering must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for backend engineering.
...
- A story affecting backend engineering updates this chapter and its executable evidence in the same review.
