# Chapter 22: Data Platform

## Purpose

Data Platform defines the shared rules, boundaries and evidence for this part of the AuraEDU education operating system.

---

## Scope

Product, engineering, operational and governance decisions directly related to data platform.
...
- Changes to data platform must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for data platform.
...
- A story affecting data platform updates this chapter and its executable evidence in the same review.
