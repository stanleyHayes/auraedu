# Chapter 11: C4 Architecture

## Purpose

C4 Architecture defines the shared rules, boundaries and evidence for this part of the AuraEDU education operating system.

---

## Scope

Product, engineering, operational and governance decisions directly related to c4 architecture.
...
- Changes to c4 architecture must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for c4 architecture.
...
- A story affecting c4 architecture updates this chapter and its executable evidence in the same review.
