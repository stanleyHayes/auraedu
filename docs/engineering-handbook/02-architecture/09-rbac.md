...
Authorisation checks identity, tenant scope, permission, feature eligibility and resource ownership in order.

---

## Scope

Product, engineering, operational and governance decisions directly related to rbac.
...
- Changes to rbac must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for rbac.
...
- A story affecting rbac updates this chapter and its executable evidence in the same review.
