# Chapter 18: Service Discovery

## Purpose

Render private networking and environment-based service URLs provide discovery today; clients must not assume Kubernetes DNS.

---

## Scope

Product, engineering, operational and governance decisions directly related to service discovery.
...
- Changes to service discovery must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for service discovery.
...
- A story affecting service discovery updates this chapter and its executable evidence in the same review.
