# Chapter 07: Multi-Tenancy

## Purpose

Tenant boundaries apply to requests, records, events, caches, jobs, logs, metrics and AI data.

---

## Scope

Product, engineering, operational and governance decisions directly related to multi-tenancy.
...
- Changes to multi-tenancy must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for multi-tenancy.
...
- A story affecting multi-tenancy updates this chapter and its executable evidence in the same review.
