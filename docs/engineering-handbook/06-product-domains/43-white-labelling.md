# Chapter 43: White Labelling

## Purpose

White labelling changes configuration, brand tokens, domains and optional distribution—not product forks.

---

## Scope

Product, engineering, operational and governance decisions directly related to white labelling.
...
- Changes to white labelling must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for white labelling.
...
- A story affecting white labelling updates this chapter and its executable evidence in the same review.
