# Chapter 33: Coding Standards

## Purpose

Coding Standards defines the shared rules, boundaries and evidence for this part of the AuraEDU education operating system.

---

## Scope

Product, engineering, operational and governance decisions directly related to coding standards.
...
- Changes to coding standards must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for coding standards.
...
- A story affecting coding standards updates this chapter and its executable evidence in the same review.
