...
AuraEDU targets WCAG 2.2 AA and treats keyboard access, focus, contrast, semantics, reflow and reduced motion as release requirements.

---

## Scope

Product, engineering, operational and governance decisions directly related to accessibility.
...
- Changes to accessibility must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for accessibility.
...
- A story affecting accessibility updates this chapter and its executable evidence in the same review.
