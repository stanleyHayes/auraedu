...
Tests prove tenant isolation, feature off-states, permissions, contracts and user outcomes—not only line coverage.

---

## Scope

Product, engineering, operational and governance decisions directly related to testing.
...
- Changes to testing must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for testing.
...
- A story affecting testing updates this chapter and its executable evidence in the same review.
