...
Kubernetes is a future portability and scale option, not the current production target. Render remains authoritative until an accepted ADR changes deployment strategy.

---

## Scope

Product, engineering, operational and governance decisions directly related to kubernetes.
...
- Changes to kubernetes must name the stakeholder outcome and operational owner.
...
This chapter links the relevant platform boundaries to contracts, diagrams, implementation directories and operational controls for kubernetes.
...
- A story affecting kubernetes updates this chapter and its executable evidence in the same review.
